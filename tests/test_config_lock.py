...
class TestConfigLock:
    ...
    def get_config_db_lock(self, tcName):
        ...
        """
        cdb = self.dvs.get_config_db()
        table = cdb.get_entry('LOCK', 'configDbLock')
    ...
    def test_lock_reset_timer(self, dvs):
        ...
        cdb = self.dvs.get_config_db()
        table = cdb.create_entry('LOCK', 'configDbLock', {'PID': '5555'})
